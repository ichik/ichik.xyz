...
sidebarcolor: "200, 100%, 40%"
backgroundcolor: "0, 0%, 100%"
textcolor: "200, 10%, 10%"
linkcolor: "220, 100%, 10%"
linkhovercolor: "220, 100%, 25%"
...
It's always interesting to take a look at behind-the-scenes work. Public rarely gets to see those early concepts and sketches, but they form and shape future ideas and solutions, define direction for future work and sometimes contain impactful decisions that make their way to the final product.
...
This is the key screen for the extension that I've settled with. It's simplistic and it solves the key task of the extension. “Users browse internet securely, privately and without restrictions.” This is my understanding of the function which defines the form. That's just my understanding, of course. I would've loved to get more input, and have actually prepared the list of questions that I would've asked were it my actual work task.
...
Yes, it's the same that you've seen before. Now with a little bit more context. I decide to go with a full color background indicating the state of the connection. It captures the user focus and declares the main purpose of the extension.
