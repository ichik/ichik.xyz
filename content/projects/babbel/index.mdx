...
The flow that we wanted to achieve from implementing our feature was a simple repetitive pattern of practice. A little help for those learners who feel a overwhelmed and start to fall behind on their studies.
...
Based on this excercise we used whiteboarded to map more detailed user flow. We noted exsiting solutions, features that were being worked on in parallel and points of impact where we wanted to add something.

![Detailed user flow](./mapping.jpg)

I sketched more detailed interface compositions for points of impact; got some quick feedback on what would the easiest to implement but still meaningful for learners from participants of the work-group who participated in workshop.
...
Prototype for qualitative user testing for mobile platform was done in Framer X. It represented very simplified used flow with certain degree of realism for the new features. Current date was always highlighted and learning data was generated randomly with new activity record being added at the end of the flow. We deployed it as a static website on AWS and sent link to participants of qualitative testing to collect their feedback and thoughts on this new feature.

<LAMobilePrototype />

With more feedback I prepared desktop prototype which was tested internally to iron out remaining questions about scope of first iteration that we wanted to deliver.

![Desktop prototype](./desktopprototype.jpg)

Team delivered the feature on desktop first. It was rolled out as an A/B test and after initial observation we registered uptick in the key metrics that we hoped for would benefit from feature's presence in users' experience.

Because of this optymistic results the feature was rolled to mobile platforms too, and later was iterated on by my colleagues. Improved experience provided more data and included positive reinforcement messaging to drive those initial improvements for our metrics even higher.
