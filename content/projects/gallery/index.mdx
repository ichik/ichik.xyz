...
<video preload="auto" autoplay loop muted volume="0" poster="./gallery.jpg" width="320" height="568">
    <source src="./screencap.webm" type='video/webm;codecs="vp8, vorbis"'/>
...
I used [Pixate](https://pixate.com) for prototyping all the interactions and animations. Its advanced object dependencies control was ideal to get right all the small things, such as taking into account thumbnail strip position on a transition to a new image. If the strip was previously scrolled and the new position is out of screen bounds, the strip will automatically scroll so the new image's thumbnail will be visible.
