...
Unlike more straightforward energy contracts telco space proved to be much more challenging. The linear user flow “check out offers → select one” transformed into a pathway with branching (contracts with mobile phone and without one).
...
Due to the large volume of offers additional filters had to be implemented.