...
When it came to creating animations, transition from homescreen to sub-screens was prototyped in Principle.
...
I also created connection animation, which was <a href="./zenmateswitch/" target="_blank">prototyped in HTML</a>.
